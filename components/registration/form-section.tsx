...
export function FormSection({
  ...
  return (
    <div className="backdrop-blur-[2.5px] backdrop-filter bg-[rgba(138,138,138,0.15)] rounded-[16px] sm:rounded-[20px] p-[20px] sm:p-[24px] md:p-[32px] relative w-full">
      ...
      <div className="flex flex-col gap-[16px] sm:gap-[20px] relative z-10">
