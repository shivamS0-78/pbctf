  ...
  return (
    <div className="flex flex-col gap-[8px] w-full">
      ...
      <select
        ...
        value={value}
        onChange={onChange}
        className="backdrop-blur-[2.5px] backdrop-filter bg-[rgba(138,138,138,0.2)] border border-[rgba(255,255,255,0.38)] border-solid rounded-[15px] px-[18px] py-[12px] text-white text-[14px] focus:outline-none focus:border-[#ff4d00] focus:shadow-[0px_0px_10px_0px_rgba(255,77,0,0.3)] transition-all appearance-none cursor-pointer"
